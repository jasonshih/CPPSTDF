...
class TestJxU1 : public CxxTest::TestSuite 
{
  public:
    void setUp()
    {
    ...
    void testWriteRead1()
    {
      const char *filename = "TestJxU1.testWriteRead1.txt";

      const size_t size = 1;

      JxTYPE<U1> stdfStrIn(size);
      std::ofstream outfile(filename, std::ofstream::binary);
      stdfStrIn.write(outfile);
      outfile.close();

      JxTYPE<U1> stdfStrOut;
    ...
    void testWriteRead2()
    {
      const char *filename = "TestJxU1.testWriteRead2.txt";
    ...
    void testWriteRead3()
    {
      const char *filename = "TestJxU1.testWriteRead3.txt";
