...
class TestJxU4 : public CxxTest::TestSuite 
{
  public:
    void setUp()
    {
    ...
    void testWriteRead1()
    {
      const char *filename = "TestJxU4.testWriteRead1.txt";

      const size_t size = 1;

      JxTYPE<U4> stdfStrIn(size);
      std::ofstream outfile(filename, std::ofstream::binary);
      stdfStrIn.write(outfile);
      outfile.close();

      JxTYPE<U4> stdfStrOut;
    ...
    void testWriteRead2()
    {
      const char *filename = "TestJxU4.testWriteRead2.txt";
    ...
    void testWriteRead3()
    {
      const char *filename = "TestJxU4.testWriteRead3.txt";
