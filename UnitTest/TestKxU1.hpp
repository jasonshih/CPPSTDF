...
class TestKxU1 : public CxxTest::TestSuite 
{
  public:
    void setUp()
    {
    ...
    void testWriteRead1()
    {
      const char *filename = "TestKxU1.testWriteRead1.txt";

      const size_t size = 1;

      KxTYPE<U1, size> stdfStrIn;
      ofstream outfile(filename, ofstream::binary);
      stdfStrIn.write(outfile);
      outfile.close();

      KxTYPE<U1, size> stdfStrOut;
    ...
    void testWriteRead2()
    {
      const char *filename = "TestKxU1.testWriteRead2.txt";
    ...
    void testWriteRead3()
    {
      const char *filename = "TestKxU1.testWriteRead3.txt";
