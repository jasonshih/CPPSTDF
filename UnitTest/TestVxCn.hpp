...
class TestVxCn : public CxxTest::TestSuite 
{
  public:
    void setUp()
    {
    ...
    void testWriteRead1()
    {
      const char *filename = "TestVxCn.testWriteRead1.txt";

      const size_t size = 1;

      VxTYPE<Cn> stdfStrIn(size);
      ofstream outfile(filename, ofstream::binary);
      stdfStrIn.write(outfile);
      outfile.close();

      VxTYPE<Cn> stdfStrOut;
    ...
    void testWriteRead2()
    {
      const char *filename = "TestVxCn.testWriteRead2.txt";
    ...
    void testWriteRead3()
    {
      const char *filename = "TestVxCn.testWriteRead3.txt";
