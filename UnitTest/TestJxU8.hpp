...
class TestJxU8 : public CxxTest::TestSuite 
{
  public:
    void setUp()
    {
    ...
    void testWriteRead1()
    {
      const char *filename = "TestJxU8.testWriteRead1.txt";

      const size_t size = 1;

      JxTYPE<U8> stdfStrIn(size);
      std::ofstream outfile(filename, std::ofstream::binary);
      stdfStrIn.write(outfile);
      outfile.close();

      JxTYPE<U8> stdfStrOut;
    ...
    void testWriteRead2()
    {
      const char *filename = "TestJxU8.testWriteRead2.txt";
    ...
    void testWriteRead3()
    {
      const char *filename = "TestJxU8.testWriteRead3.txt";
